...
#	f=open('Gphocs_input_canfam3.1_subset_newGrange_GQ30_BQ15_MQ15_DP7_unrecal_aDNA.txt',"w")
	f=open('Gphocs_input_canfam3.1_newGrange_subset5_GQ30_BQ15_MQ15_DP7_unrecal_aDNA.txt',"w")
	remove_locus=[]
	print >>f,"26250"
	f.write("\n")
#	f_matrix=open("dist_matrix_canfam3_MQ0_DP0_GQ20.txt","w")
#	f_matrix=open("dist_matrix_canfam3.1_subset_newGrange_GQ30_BQ15_MQ15_DP7_unrecal_aDNA.txt","w")
	f_matrix=open("dist_matrix_canfam3.1_newGrange_subset5_GQ30_BQ15_MQ15_DP7_unrecal_aDNA.txt","w")
...
#	print 12
	...
	f=open('sampleList_subset5.txt','r')
