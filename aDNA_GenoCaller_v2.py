...
###This version of the program will take any genotype with a low quality heterozygote call and convert to the next best homozygote call
...
filenamein=argv[1]#'/vault/veeramah/dog/processed/run1_2/CanFam3/merged_all_run1_run2.MKdup.RG.sort.realign.bam'
filenameinB=argv[2]#'neutralLoci-geneFlank10k-sep30k.bed'
ref_file=argv[3]#'/vault/public/dog/canfam3.fa'
mapdamageCT=argv[4]#'/vault/veeramah/dog/processed/run1_2/CanFam3/mapDamage_res/mapDamage_res_rand0.1_A/5pCtoT_freq.txt'
mapdamageGA=argv[5]#'/vault/veeramah/dog/processed/run1_2/CanFam3/mapDamage_res/mapDamage_res_rand0.1_A/3pGtoA_freq.txt'
filenameout=argv[6]
'''
min_RD=7 #int(argv[3])
MQ=15 #float(argv[4])
